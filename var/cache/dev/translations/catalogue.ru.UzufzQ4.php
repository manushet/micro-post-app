...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'register.emailused' => 'Этот адрес эл. почты уже используется',
    'register.usernameused' => 'Этот логин уже используется',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'menu.add_post' => 'Добавить новую запись',
    'post.recent' => 'Последние обновления',
    'register.terms' => 'Я согласен с правилами пользовательского соглашения',
    'register.username' => 'Логин',
    'register.password' => 'Пароль',
    'register.repeated_password' => 'Подтвердите пароль',
    'register.full_name' => 'Полное имя',
    'register.register_btn' => 'Регистрация',
    'notifications.none' => 'У вас нет новых уведомлений',
    'email.registration' => '<h3>Благодарим вас за регистрацию на нашем сайте!</h3><p>Здравствуйте, %name%! Вы успешно создали аккаунт в нашем приложении.</p><p>Пожалуйста, подтвердите ваш адрес эл. почты, пройдя <a href="%confirm-link%">по этой ссылке</a>.</p><p>Войти в свой аккаунт вы можете <a href="%login-link%">на странице авторизации</a>.</p><p>Спасибо и хорошего вам дня!</p>',
    'user.followers' => '%count% Подписчиков',
    'user.following' => '%count% в Избранном',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'register.emailused' => 'This e-mail is already used',
    'register.usernameused' => 'This username is already used',
  ),
  'security' => 
  array (
  ...
  'messages' => 
  array (
    'menu.signin' => 'Signs in',
    'menu.signout' => 'Sign out',
    'menu.notifications' => 'Notifications',
    'menu.add_post' => 'Add new post',
    'post.recent' => 'Recent updates',
    'register.terms' => 'I agree to the terms of service',
    'register.username' => 'Username',
    'register.password' => 'Password',
    'register.repeated_password' => 'Repated password',
    'register.full_name' => 'Full name',
    'register.register_btn' => 'Register',
    'notifications.none' => 'You have not notifications',
    'email.registration' => '<h3>Thank you for joining us!</h3><p>Hello, %name%! You`ve been successfully registered into our app.</p><p>Please, confirm your email address by clicking <a href="%confirm-link%">on this link</a>.</p><p>To log in go to <a href="%login-link%">login page</a>.</p><p>Thank you and have a nice day!</p>',
